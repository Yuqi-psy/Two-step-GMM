...
#### table for MSE ####
MSE_1c3 <- rbind(results_3t$table_MSE_c1,results_3t$table_MSE_c2)
MSE_1c6 <- rbind(results_6t$table_MSE_c1,results_6t$table_MSE_c2)
...
se_13 <- rbind(results_3t$table_se_c1,results_3t$table_se_c2)
se_16 <- rbind(results_6t$table_se_c1,results_6t$table_se_c2)
...
MSE_1i3 <- rbind(results_3t$mse_c1, results_3t$mse_c2)
MSE_1i6 <- rbind(results_6t$mse_c1, results_6t$mse_c2)
MSE_1i <- cbind(MSE_1i3, MSE_1i6) # gamma_0

MSE_1s3 <- rbind(results_3t$mse_1s_c1, results_3t$mse_1s_c2)
MSE_1s6 <- rbind(results_6t$mse_1s_c1, results_6t$mse_1s_c2)
MSE_1s <- cbind(MSE_1s3, MSE_1s6) # gamma_1
...
#  theme(axis.text.y = element_text(face=rep(c("bold", "plain"),2), size = 16))+ # study 3 bold specification C
  ...
  scale_x_discrete(limits=c( "Step-1 C", "Step-1 B",
